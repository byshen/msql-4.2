...
#  define TEXT_REGEX_ERROR	"Can't use TEXT fields in LIKE comparison\n"
...
#  define DATE_ERROR		"Invalid date format \"%s\""
#  define TIME_ERROR		"Invalid time format \"%s\""
#  define IPV4_ERROR		"Invalid IPv4 format \"%s\""
#  define IPV6_ERROR		"Invalid IPv6 format \"%s\""
